    ...
    private static void rewritesGenericCollectionOperationsForBusinessReaders() {
        BusinessDecisionGraph exact = graph("prepare records", BusinessDecisionGraph.Completeness.COMPLETE,
                List.of(
                        ...
                        node("mapped-transfer", BusinessDecisionGraph.NodeKind.COMPUTATION,
                                "add map order order details to order detail list"),
                ...
                List.of(
                        ...
                        edge("e4", "access", "mapped-transfer", "next"),
                        edge("e5", "mapped-transfer", "groups", "next"),
                        edge("e6", "groups", "search", "next"),
                        edge("e7", "search", "grant", "next"),
                        edge("e8", "grant", "attributes", "next"),
                        edge("e9", "attributes", "stop", "true; returns prepared"),
                        edge("e10", "attributes", "stop", "false; returns unchanged")),
                List.of());
        ...
        assert labels.containsAll(List.of(
                ...
                "add converted order details to order detail list",
                "set groups",
                "search for accounts",
