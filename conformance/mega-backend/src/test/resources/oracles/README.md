...
| `determine-journey-warnings.txt` | manager collection flow; all three selected strategy rules; business-safe entry iteration; atomic filtering, direction, absence, and warning predicates; convergence and final list | `e28df93eea7fdbf213af0c0445908bc21fdcb21c53f2a9c2c04e55033f5bdd51` | Approved |
