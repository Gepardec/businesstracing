	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				success: "border-status-success/20 bg-status-success/12 text-status-success",
				warning: "border-status-running/25 bg-status-running/14 text-[oklch(0.48_0.14_70)] dark:text-status-running",
